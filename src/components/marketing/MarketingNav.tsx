  ...
  return (
    <nav className="bg-primary-container text-white sticky top-0 z-50 shadow-lg">
      <div className="max-w-container-max mx-auto px-gutter py-4 flex justify-between items-center">
        {/* Logo */}
        <Link href="/" onClick={close} className="flex items-center gap-3 min-w-0 shrink" aria-label="Bhagini Graphics — home">
      ...
      {/* Mobile menu */}
      {open && (
        <div id="mobile-menu" className="lg:hidden border-t border-white/10 bg-primary-container shadow-xl">

        ...
        <header className="sticky top-0 z-40 flex justify-between items-center px-4 md:px-margin-desktop py-4 bg-surface border-b border-outline-variant">
          ...
          <div className="flex items-center gap-2 sm:gap-6 ml-2 sm:ml-8">
            <div className="flex items-center gap-1 sm:gap-4">
              ...
              <button className="p-2 rounded-full hover:bg-surface-container-high transition-all hidden sm:block">
            ...
            <div className="flex items-center gap-3 cursor-pointer">
              <div className="text-right hidden sm:block">
                <p className="font-button text-on-surface leading-none">Admin</p>
